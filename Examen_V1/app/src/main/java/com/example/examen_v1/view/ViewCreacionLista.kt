...
class ViewCreacionLista : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        botonCrearLista.setOnClickListener {
            ...
            val nuevaLista = ListaReproduccion(null, nombreLista, reproduccionAleatoria, null, null)
            if (nuevaLista != null) mostrarSnackbar("Lista creada exitosamente") else mostrarSnackbar(
