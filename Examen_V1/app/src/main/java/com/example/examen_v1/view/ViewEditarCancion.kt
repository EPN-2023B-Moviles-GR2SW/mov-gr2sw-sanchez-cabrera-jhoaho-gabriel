...
class ViewEditarCancion : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        botonGuardarCancion.setOnClickListener {
            ...
            Cancion.getById(idCancion)!!.actualizarNombre(nombreCancion)
            Cancion.getById(idCancion)!!.actualizarDuracion(duracionCancion)
            Cancion.getById(idCancion)!!.actualizarAutor(autorCancion)
            Cancion.getById(idCancion)!!.actualizarFavorita(favoritaCancion)
